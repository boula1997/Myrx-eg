    ...
    >
      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <div style="border-radius: 0 0 1.5rem 1.5rem;margin: -7% 22%;background-color: #0082c3;width: 132px;height: 64px;">
            <a href="{{route('landingPage')}}" class="logo d-flex align-items-center">
              
              <span style="font-size: 28px; margin: 0 25px; color:white">My Rx</span>
            </a> 
            {{-- <img style="width:70%; height: 70%; margin:0 0 0 10%;" src="{{asset('public/FlexStart/assets/photos/hccs-logo.png')}}" > --}}
          </div>
          ...
          <ul class="mt-6" style="border-color: gray;">
            <li class="relative px-6 py-3">
              <!-- <span class="ml-4">National ID</span> -->
