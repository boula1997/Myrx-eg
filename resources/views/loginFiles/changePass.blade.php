                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">Change Passwprd</h1>
                                        <p class="mb-4">We get it, stuff happens. Just enter your current password and new password</p>
                                    </div>
                                    ...
                                    <form method="post" action="{{ route('changePass')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="email" type="email" class="form-control form-control-user @error('email') is-invalid @enderror" name="email" value="{{Auth::user()->email}}" disabled>
                                            @error('email')
                                        ...
                                        <div class="form-group">
                                            <input id="password" type="password" placeholder="Currect Password" class="form-control form-control-user @error('password') is-invalid @enderror" name="password" required autocomplete="password">
                                            @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            <input id="new_password" type="password" placeholder="New Password" class="form-control form-control-user @error('new_password') is-invalid @enderror" name="new_password" required autocomplete="new_password">
                                            @error('new_password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <hr>
                                    {{-- <div class="text-center">
                                        <a class="small" href="{{asset('public/registerAs')}}">Create an Account!</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="{{asset('public/loginAs')}}">Already have an account? Login!</a>
                                    </div> --}}
                                </div>
                            </div>
                        </div>
