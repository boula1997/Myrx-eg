                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">{{$type}} Forgot Password?</h1>
                                        <p class="mb-4">We get it, stuff happens. Just enter your email address below
                                            and we'll send you a link to reset your password!</p>
                                    </div>
                                    
                                   
                                    <form method="POST" class="user" action="{{ route($url.'.password.email') }}">                                   
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{route('landingPage')}}">Create an Account!</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="{{route($url)}}">Already have an account? Login!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
