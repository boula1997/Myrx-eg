...
<body class="bg-gradient-primary">
    ...
    <div class="container">
        ...
        <!-- Outer Row -->
        <div class="row justify-content-center" style="margin: 10px 0px;">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    @endisset
                                        ...
                                        {{-- <hr>
                                        <a href="index.html" class="btn btn-google btn-user btn-block" style="pointer-events: none;">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{route($url.'.password.update')}}">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
