...
@section('body')
  <body class="orchid">
    <div class="modal fade" id="exampleModalCenter2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="display: block;">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <div class="p-t-15">
              <span style="float: left;"><span style="font-weight: bold" >Address: </span>{{--address--}}</span>
              <span style="float: right;"> <span style="font-weight: bold" > Phone:</span>{{--number--}}</span>
      ...
      <div class="mainmenu-block" style="background: linear-gradient(to top, #162232, #3A60AD);">
        <nav class="menu-block">
          <ul class="nav">
            ...
            <div class="menu-block-label"><b>First Last{{--$patient->fname}} {{$patient->lname--}}</b><br>-</div></a></li>
          </ul>
          <div class="menu-block-label" style="line-height: 2;margin: 10px 0 7px 0px;">
            <span>Phone Number: 00000000000{{-- $patient->phone--}}</span>
            <br>
            <span>Age: {{--now()->year-date('Y', strtotime($patient->dob))--}} Y</span>
          </div>
          <div class="menu-block-label">
            <button type="button" class="btn btn-primary btn-lg" style="margin-bottom: 2%; width:158px" data-toggle="modal" data-target="#exampleModalCenter2" >
              <p>Old Pres</p>
            </button>
            <button type="button" class="btn btn-primary btn-lg" style="margin-bottom: 2%; width:158px" data-toggle="modal" data-target="#exampleModalCenter2" >
              <p>Old Pres</p>
            ...
            {{-- @foreach ($examinations as $examination)
              @if ($examination->doctor_id==Auth::guard('doctor')->user()->id && $examination->patient->phone==$national_id)
