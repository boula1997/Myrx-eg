...
<body>
  <div class="row">
    ...
    <div class="col-md-12">
      <iframe src="{{ asset('public/materials/'.$examination->document) }}" width="100%" height="600px">
        This browser does not support PDFs. Please download the PDF to view it: <a href="{{ asset('public/materials/'.$examination->document) }}">Download PDF</a>
      </iframe>
    </div>
